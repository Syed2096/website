...
function CryptoBot() {
  ...
  async function getImage1(coinName) {
    await fetch('https://0747-2607-fea8-d20-873a-6599-6e2b-7fb6-a6a9.ngrok.io/image1', {
      method: 'POST',
  ...
  async function getImage2(coinName) {
    await fetch('https://0747-2607-fea8-d20-873a-6599-6e2b-7fb6-a6a9.ngrok.io/image2', {
      method: 'POST',
      body: JSON.stringify({ coin : coinName})
    }).then(validateResponse)
    .then(response => response.blob())
