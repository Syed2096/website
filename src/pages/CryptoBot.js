...
function CryptoBot() {
  ...
  async function getImage1(coinName) {
    await fetch('https://b2fc-2607-fea8-d20-873a-e133-1523-a477-aa3.ngrok.io/image1', {
      method: 'POST',
  ...
  async function getImage2(coinName) {
    await fetch('https://b2fc-2607-fea8-d20-873a-e133-1523-a477-aa3.ngrok.io/image2', {
      method: 'POST',
      body: JSON.stringify({ coin : coinName})
    }).then(validateResponse)
    .then(response => response.blob())
